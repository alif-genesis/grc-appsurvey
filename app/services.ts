...
const LOCAL_BASE_PATH = process.env.NEXT_PUBLIC_BASE_PATH || '';
export const GENESIS_LOGO_URL = `${LOCAL_BASE_PATH}/genetika-1-warna.png`;
export const KOMDIGI_LOGO_URL = `${LOCAL_BASE_PATH}/komdigi-logo.svg`;
